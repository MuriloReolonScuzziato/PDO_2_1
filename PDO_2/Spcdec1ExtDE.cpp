...
CMatrizEsparsa Spcdec1ExtDE::MatrizRestDemanda()	// Monta matriz da restrição de atendimento a demanda
{
	// T * B
	int n_a = no;
	...
	for ( int t = 0; t < T; t++)
	{
		...
		Alin.InserirMatriz(l, c + (3+flag4+flag7)*(sistema_a->termeletricasVtr.size()) + sistema_a->barrasVtr.size() - 1 + 4*(sistema_a->hidreletricasVtr.size()) + 3*JJ, l + sistema_a->barrasVtr.size() - 1, c + (3+flag4+flag7)*(sistema_a->termeletricasVtr.size()) + sistema_a->barrasVtr.size() - 1 + 4*(sistema_a->hidreletricasVtr.size()) + 3*JJ + sistema_a->barrasVtr.size() - 1, &Adef, 0, 0);
...
CMatrizEsparsa Spcdec1ExtDE::MatrizRestDemandaBarraUnica()	// Monta matriz da restrição de atendimento a demanda
{
	int n_a = no;
	n_a = n_a - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
	...
	for ( int t = 0; t < T; t++)
	{
		...
		if ( flag1 == 0)
			a.InserirElemento(0, (3+flag4+flag7)*sistema_a->termeletricasVtr.size() + 4*sistema_a->hidreletricasVtr.size() + 3*JJ + c, 1);		// def
		else // flag1 == 2
			for (size_t b = 0; b < sistema_a->barrasVtr.size(); b++)		// def
				a.InserirElemento(0, b + c + (3+flag4+flag7)*sistema_a->termeletricasVtr.size() + 4*sistema_a->hidreletricasVtr.size() + 3*JJ, 1);		// def
		Alin.JuntarColuna(&a);
		if (((t + 1 - sistema_a->GetTt1())%(sistema_a->GetTt2() - sistema_a->GetTt1()) == 0) && ((t + 1 - sistema_a->GetTt1()) > 0))
			c = c + (n_a / T) + flag2*sistema_a->hidreletricasVtr.size();
		else
...
CMatrizEsparsa Spcdec1ExtDE::MatrizLimFluxo()
{
	int n_a = no;
	...
	else // flag1 == 2
	{
		...
		for ( int t = 0; t < T; t++)
		{
			...
			Alin.InserirMatriz(l, c + (3+flag4+flag7)*(sistema_a->termeletricasVtr.size()) + 4*sistema_a->hidreletricasVtr.size() + 3*JJ, l + sistema_a->linhasVtr.size() - 1, c + (3+flag4+flag7)*(sistema_a->termeletricasVtr.size()) + 4*sistema_a->hidreletricasVtr.size() + 3*JJ + sistema_a->barrasVtr.size() - 1, Adef, 0, 0);
...
CMatrizEsparsa Spcdec1ExtDE::MatrizLimPhgMin()
{
	int n_a = no;
	int JJ = 0;
	...
	for (int t = 0; t < T; t++)
	{
		Alin.InserirMatriz(l,c + ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size()),l + JJ - 1,c + ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size()) + JJ - 1, &A1, 0, 0);
		Alin.InserirMatriz(l,c + ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size() + 2*JJ),l + JJ - 1,c + ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size()) + 3*JJ - 1, &A2, 0, 0);
		l = l + JJ;
		if (((t + 1 - sistema_a->GetTt1())%(sistema_a->GetTt2() - sistema_a->GetTt1()) == 0) && ((t + 1 - sistema_a->GetTt1()) > 0))
			c = c + (n_a / T) + flag2*sistema_a->hidreletricasVtr.size();
		else
...
CMatrizEsparsa Spcdec1ExtDE::MatrizLimPhgMax()
{
	int n_a = no;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Spcdec1ExtDE::MatrizBalHid()
{
	int n_a = no;
	double deltaT;
	int tempo_viagem;
...
CMatrizEsparsa Spcdec1ExtDE::MatrizLimqMin()
{
	int n_a = no;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
	...
	for (int t = 0; t < T; t++)
	{
		Alin.InserirMatriz(l,c + ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size()) + JJ,l + JJ - 1,c + ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size()) + 2*JJ - 1, &A1, 0, 0);
		Alin.InserirMatriz(l,c + ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size() + 2*JJ),l + JJ - 1,c + ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size()) + 3*JJ - 1, &A2, 0, 0);
		l = l + JJ;
		if (((t + 1 - sistema_a->GetTt1())%(sistema_a->GetTt2() - sistema_a->GetTt1()) == 0) && ((t + 1 - sistema_a->GetTt1()) > 0))
			c = c + (n_a / T) + flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Spcdec1ExtDE::MatrizLimqMax()
{
	int n_a = no;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Spcdec1ExtDE::MatrizTup()
{
	if (flag7 == 0)
	{
		// T * sum(Tup)
...
CMatrizEsparsa Spcdec1ExtDE::MatrizTdown()
{
	if (flag7 == 0)
	{
		// T * sum(Tdown)
...
CMatrizEsparsa Spcdec1ExtDE::MatrizTupDown()
{
...
CMatrizEsparsa Spcdec1ExtDE::MatrizRampaUp()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Spcdec1ExtDE::MatrizRampaDown()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Spcdec1ExtDE::MatrizLimPtMin()
{
	if (flag7 == 0)
	{
		// T * I
...
CMatrizEsparsa Spcdec1ExtDE::MatrizLimPtMax()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Spcdec1ExtDE::MatrizRestCP()
{
	// T * I
	int n_a = no;
	n_a = n_a - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Spcdec1ExtDE::MatrizVmeta()
{
	int n_a = no;
	size_t R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
...
CMatrizEsparsa Spcdec1ExtDE::MatrizBalPotencia()
{
	int n_a = no;
	n_a = n_a - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Spcdec1ExtDE::MatrizBalVazao()
{
	int n_a = no;
	n_a = n_a - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Spcdec1ExtDE::MatrizFuncProd()
{
	int n_a = no;
	n_a = n_a - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Spcdec1ExtDE::MatrizReserva()
{
	int n_a = no;
	n_a = n_a - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Spcdec1ExtDE::MatrizCortesF()
{
	// T * I
	int n_a = no;
	n_a = n_a - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Spcdec1ExtDE::MatrizRestAux()
{
	// x - xa = 0
	int n_a = no;
	n_a = n_a - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
	...
	cc = 0;
	cca = no;
	cprecod = sistema_a->termeletricasVtr.size() + sistema_a->hidreletricasVtr.size();
	for (int t = 0; t < T; t++)
	{
		if (((t + 1 - sistema_a->GetTt1())%(sistema_a->GetTt2() - sistema_a->GetTt1()) == 0) && ((t + 1 - sistema_a->GetTt1()) > 0))
			nt = (n_a / T) + flag2*sistema_a->hidreletricasVtr.size();
...
vetorfloat2 Spcdec1ExtDE::LimRestDemanda()
{
...
vetorfloat2 Spcdec1ExtDE::LimRestDemandaBarraUnica()
{
	size_t B = sistema_a->barrasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec1ExtDE::LimFluxo0()
{
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec1ExtDE::LimFluxo2()
{
	vetorfloat2 Lim;
	size_t L = sistema_a->linhasVtr.size();
	size_t B = sistema_a->barrasVtr.size();
...
vetorfloat2 Spcdec1ExtDE::LimPhgMin()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Spcdec1ExtDE::LimPhgMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Spcdec1ExtDE::LimBalHid()
{
	double deltaT;
	int cenario;
	int periodo;
...
vetorfloat2 Spcdec1ExtDE::LimQMin()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Spcdec1ExtDE::LimQMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Spcdec1ExtDE::LimTup()
{
	if (flag7 == 0)
	{
...
vetorfloat2 Spcdec1ExtDE::LimTdown()
{
	if (flag7 == 0)
	{
		int I = sistema_a->termeletricasVtr.size();
...
vetorfloat2 Spcdec1ExtDE::LimTupDown()
{
	// T * I	(nos primeiros periodos tem-se linhas com 0, pois não são consideradas determinadas restrições para t < 2 ou t < Tup + 2 ou t < Tdown + 2
	size_t I = sistema_a->termeletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec1ExtDE::LimRampaUp()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Spcdec1ExtDE::LimRampaDown()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Spcdec1ExtDE::LimPtMin()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Spcdec1ExtDE::LimPtMax()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Spcdec1ExtDE::LimRestCP()
{
	// T * I
	int I = sistema_a->termeletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec1ExtDE::LimVmeta()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec1ExtDE::LimBalPotenciaL()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Spcdec1ExtDE::LimBalVazaoL()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Spcdec1ExtDE::LimFuncProdL()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int i = 0; i < R; i++)
...
vetorfloat2 Spcdec1ExtDE::LimReserva()
{
	size_t B = sistema_a->barrasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec1ExtDE::LimCortesF()
{
	// T * I
	int I = sistema_a->termeletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec1ExtDE::LimRestAux()
{
	int R = sistema_a->hidreletricasVtr.size();
	int I = sistema_a->termeletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, T * (I + R), 2);
	IniciaMatriz(&Lim, 0);
	for (size_t i = 0; i < Lim.size(); i++)
		Lim[i][0] = 1;
	return Lim;
...
void Spcdec1ExtDE::MatrizRestricoesLineares(CMatrizEsparsa &MM)		// Matriz M é composta de 3 vetores, cada coluna (vetor) é : [indexL indexC Valor]
{
	CMatrizEsparsa M(0);
	int count = 0;
...
void Spcdec1ExtDE::MatrizLimitesLineares(vetorint * LimTipo, vetorfloat * LimValor)
{
	vetorfloat2 L;
	if ( sistema_a->GetFlagModeloRede() == 1 )
	{
...
Spcdec1ExtDE::Spcdec1ExtDE(CSistema * const sistema_end) :ambGRB(GRBEnv()),modeloGRB(GRBModel(ambGRB))
{
	...
	for (size_t i = 0; i < sistema_a->hidreletricasVtr.size(); i++)
		JJ = JJ + sistema_a->hidreletricasVtr[i].GetNGrupos();
	no = T * ((3+flag4+flag7)*sistema_a->termeletricasVtr.size() + sistema_a->barrasVtr.size() - 1 + 4*sistema_a->hidreletricasVtr.size() + 3*JJ + sistema_a->barrasVtr.size()) + flag2 * sistema_a->hidreletricasVtr.size() * sistema_a->GetNCenarios();
...
Spcdec1ExtDE::~Spcdec1ExtDE(void)
{
	delete vars;
	delete constr;
}

void Spcdec1ExtDE::CriarVariaveis()
{
	try 
	{
		size_t I = sistema_a->termeletricasVtr.size();
...
void Spcdec1ExtDE::CriarRestricoes()
{
	try
	{
		vetorint LimTipo;
...
void Spcdec1ExtDE::CriarFuncaoObjetivo()
{
	try 
	{
		GRBQuadExpr fo;
		// xo = [pt u cp F teta ph v d s phg q z def vfol]
		// xa = [pta pha]
		// x = [x xa]
		...
		int JJ = 0;
			for (size_t i = 0; i < sistema_a->hidreletricasVtr.size(); i++)
				JJ = JJ + sistema_a->hidreletricasVtr[i].GetNGrupos();
		delta = (3+flag4)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size() + 3*JJ;
		for (int t = 0; t < T; t++)
		{
			if (((t + 1 - sistema_a->GetTt1())%(sistema_a->GetTt2() - sistema_a->GetTt1()) == 0) && ((t + 1 - sistema_a->GetTt1()) > 0))
				nt = (n_a / T) + flag2*sistema_a->hidreletricasVtr.size();
...
void Spcdec1ExtDE::CriarFuncaoObjetivo2()
{
	try 
	{
		GRBQuadExpr fo;
		// x = [pt u up ud F teta ph v d s phg q z def vfol]
		// xa = [pta pha]
		// x = [x xa]
		double coeficiente;
		GRBVar variavel;
		...
		int JJ = 0;
			for (size_t i = 0; i < sistema_a->hidreletricasVtr.size(); i++)
				JJ = JJ + sistema_a->hidreletricasVtr[i].GetNGrupos();
		delta = (3+flag4+flag7)*sistema_a->termeletricasVtr.size() + flag1a*(sistema_a->barrasVtr.size() - 1) + 4*sistema_a->hidreletricasVtr.size() + 3*JJ;
		for (int t = 0; t < T; t++)
		{
			if (((t + 1 - sistema_a->GetTt1())%(sistema_a->GetTt2() - sistema_a->GetTt1()) == 0) && ((t + 1 - sistema_a->GetTt1()) > 0))
				nt = (n_a / T) + flag2*sistema_a->hidreletricasVtr.size();
...
void Spcdec1ExtDE::FixarCondIniciais()
{
	int n_a = no - flag2*sistema_a->GetNCenarios()*sistema_a->hidreletricasVtr.size();
	size_t I = sistema_a->termeletricasVtr.size();
	int c = 0;
...
double Spcdec1ExtDE::ResolverProblema(LMRow lambda, Results * results)
{
	try
	{
