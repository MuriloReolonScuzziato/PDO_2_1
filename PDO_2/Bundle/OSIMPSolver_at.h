...
/* If OSIMPSOLVERLOG > 0, the OSIMPSolver class produces a log of its activities
   on the ostream object and at the "level of verbosity" set with the method
   SetMPLog() [see below]. */
