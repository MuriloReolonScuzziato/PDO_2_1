...
/*--------------------------------------------------------------------------*/
   ...
   inline HpNum ReadFiBLambda( cIndex wFi = Inf<Index>() );
...
inline HpNum QPPenaltyMP::ReadFiBLambda( cIndex wFi )
{
 return( ActBDim <= ActCNum ? Inf<HpNum>() :
	                      - tCurr * ReadzNorm() - ReadSigma() );
 }
