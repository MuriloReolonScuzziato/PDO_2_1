...
/** @file
 * 
 * Oracle para a decomposiçao por cenários 1
...
//#include "Scndec1Hrstc.h"

#include "Bundle.h"

typedef vector<Scndec1SPC *> vetorSPC;
...
/*--------------------------------------------------------------------------*/
	...
	Scndec1Fi( CSistema * const sistema_end , Scndec1Results * const resultadosGurobi_end, int tipo_dual);
...
/*--------------------------------------------------------------------------*/
	...
	//void SetHeuristic ( Scndec1Hrstc *heuristic );
