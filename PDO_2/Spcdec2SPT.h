...
public:
	Spcdec2SPT(CSistema * const sistema_end, const GRBEnv &ambiente_gurobi);
	~Spcdec2SPT(void);

	int ResolverProblemaRL(Spcdec2Results * resultadoGurobi, const vetorfloat * const lambda, const int iter, int usina);
