...
CMatrizEsparsa Scndec2SPC::MatrizRestDemanda()	// Monta matriz da restrição de atendimento a demanda
{
	// T * B
	int n_a = n;
...
CMatrizEsparsa Scndec2SPC::MatrizRestDemandaBarraUnica()	// Monta matriz da restrição de atendimento a demanda
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec2SPC::MatrizLimFluxo()
{
	int n_a = n;
...
CMatrizEsparsa Scndec2SPC::MatrizLimPhgMin()
{
	int n_a = n;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Scndec2SPC::MatrizLimPhgMax()
{
	int n_a = n;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Scndec2SPC::MatrizBalHid()
{
	// T * R
	int n_a = n;
	double deltaT;
...
CMatrizEsparsa Scndec2SPC::MatrizLimqMin()
{
	int n_a = n;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Scndec2SPC::MatrizLimqMax()
{
	int n_a = n;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Scndec2SPC::MatrizTup()
{
...
CMatrizEsparsa Scndec2SPC::MatrizTdown()
{
...
CMatrizEsparsa Scndec2SPC::MatrizTupDown()
{
...
CMatrizEsparsa Scndec2SPC::MatrizRampaUp()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec2SPC::MatrizRampaDown()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec2SPC::MatrizLimPtMin()
{
	if (flag7 == 0)
	{
		// T * I
...
CMatrizEsparsa Scndec2SPC::MatrizLimPtMax()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec2SPC::MatrizRestCP()
{
	// T * I
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec2SPC::MatrizVmeta()
{
	int n_a = n;
	size_t R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
...
CMatrizEsparsa Scndec2SPC::MatrizBalPotencia()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec2SPC::MatrizBalVazao()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec2SPC::MatrizFuncProd()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec2SPC::MatrizPhMax()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec2SPC::MatrizReserva()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec2SPC::MatrizCortesF()
{
	// T * I
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
vetorfloat2 Scndec2SPC::LimRestDemanda()
{
...
vetorfloat2 Scndec2SPC::LimRestDemandaBarraUnica()
{
	size_t B = sistema_a->barrasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec2SPC::LimFluxo0()
{
	vetorfloat2 Lim;
...
vetorfloat2 Scndec2SPC::LimFluxo2()
{
	vetorfloat2 Lim;
	size_t L = sistema_a->linhasVtr.size();
	size_t B = sistema_a->barrasVtr.size();
...
vetorfloat2 Scndec2SPC::LimPhgMin()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec2SPC::LimPhgMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec2SPC::LimBalHid()
{
	double deltaT;
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec2SPC::LimQMin()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec2SPC::LimQMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec2SPC::LimTdown()
{
	if (flag7 == 0)
	{
		int n_a = n;
...
vetorfloat2 Scndec2SPC::LimTupDown()
{
...
vetorfloat2 Scndec2SPC::LimRampaUp()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec2SPC::LimRampaDown()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec2SPC::LimPtMin()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec2SPC::LimPtMax()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec2SPC::LimRestCP()
{
	// T * I
	int n_a = n;
	int I = sistema_a->termeletricasVtr.size();
...
vetorfloat2 Scndec2SPC::LimVmeta()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec2SPC::LimBalPotenciaL()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec2SPC::LimBalVazaoL()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec2SPC::LimFuncProdL()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int i = 0; i < R; i++)
...
vetorfloat2 Scndec2SPC::LimPhMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec2SPC::LimReserva()
{
	size_t B = sistema_a->barrasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec2SPC::LimCortesF()
{
	// T * I
	int I = sistema_a->termeletricasVtr.size();
	vetorfloat2 Lim;
...
void Scndec2SPC::MatrizRestricoesLineares(CMatrizEsparsa &MM)		// Matriz M é composta de 3 vetores, cada coluna (vetor) é : [indexL indexC Valor]
{
	CMatrizEsparsa M(0);
...
void Scndec2SPC::MatrizLimitesLineares(vetorint * LimTipo, vetorfloat * LimValor)
{
	vetorfloat2 L;
	if ( sistema_a->GetFlagModeloRede() == 1 )
	{
...
Scndec2SPC::Scndec2SPC(CSistema * const sistema_end, const GRBEnv &ambiente_gurobi)
{
	...
	modeloGRB->getEnv().set(GRB_DoubleParam_TimeLimit, 120);				// Limita o tempo de resolução do problema
}
Scndec2SPC::Scndec2SPC(CSistema * const sistema_end, int cenario_a, Scndec2SPC &cenario0)
{
	sistema_a = sistema_end;
	cenario = cenario_a;
...
Scndec2SPC::~Scndec2SPC(void)
{
	delete modeloGRB;
	delete vars;
}

void Scndec2SPC::CriarVariaveis()
{
	try 
	{
		size_t I = sistema_a->termeletricasVtr.size();
...
void Scndec2SPC::CriarRestricoes()
{
	try
	{
		vetorint LimTipo;
...
void Scndec2SPC::AtualizarRestricoes()
{
	try
	{
...
void Scndec2SPC::CriarFuncaoObjetivoRL(const vetorfloat &coefRL)
{
	// Funçao Lagrangiana
	try 
	{
		...
		for (int t = 0; t < T; t++)
		{
			if ((0 <= t) && (t < sistema_a->GetTt1()))		// nós do estágio 1
			{
				...
				for (int r = 0; r < R; r++)
				{
					vars[r + I*(3 + flag4 + flag7) + flag1a*(B - 1) + 2*R + delta].set(GRB_DoubleAttr_Obj, coefRL[r + 2*I + delta_coef]);	//d
					for (int j = 0; j < sistema_a->hidreletricasVtr[r].GetNGrupos(); j++)
						vars[j + jj + delta].set(GRB_DoubleAttr_Obj, coefRL[j + jjj + delta_coef]);						//phg
					jj += sistema_a->hidreletricasVtr[r].GetNGrupos();
					jjj += sistema_a->hidreletricasVtr[r].GetNGrupos();
				}
			}
	...
	{
			cout << "Exception during Scndec2SPC::CriarFuncaoObjetivoRL()" << endl;	
	}
}
void Scndec2SPC::FixarCondIniciais()
{
...
int Scndec2SPC::ResolverProblemaRL(Scndec2Results * resultadoGurobi, const vetorfloat2 &lambda, const int iter)
{
