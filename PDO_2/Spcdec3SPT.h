...
public:
	Spcdec3SPT(CSistema * const sistema_end, const GRBEnv &ambiente_gurobi);
	~Spcdec3SPT(void);

	int ResolverProblemaRL(Spcdec3Results * resultadoGurobi, const vetorfloat * const lambda, const int iter, int usina);
