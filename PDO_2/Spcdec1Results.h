...
class Spcdec1Results : public Results
{
	//vetorfloat x, xa, obj_subp, x_med, lambda;
	//int n, na, R, N, I, status;
...
public:
	Spcdec1Results(CSistema * const sistema_end);
	~Spcdec1Results(void);
	...
	void ZerarSolucoes();
	void CalcularNormaSubgXtil(vetorfloat &norma1, vetorfloat &norma2);
