...
CMatrizEsparsa Scndec1ExtDE::MatrizRestDemanda()	// Monta matriz da restrição de atendimento a demanda
{
	// T * B
	int n_a = n;
...
CMatrizEsparsa Scndec1ExtDE::MatrizRestDemandaBarraUnica()	// Monta matriz da restrição de atendimento a demanda
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec1ExtDE::MatrizLimFluxo()
{
	int n_a = n;
...
CMatrizEsparsa Scndec1ExtDE::MatrizLimPhgMin()
{
	int n_a = n;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Scndec1ExtDE::MatrizLimPhgMax()
{
	int n_a = n;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Scndec1ExtDE::MatrizBalHid()
{
	// T * R
	int flag1a = 0;		// referente à var. teta
	if (flag1 == 1)
...
CMatrizEsparsa Scndec1ExtDE::MatrizLimqMin()
{
	int n_a = n;
	int JJ = 0;
	int flag1a = 0;		// referente à var. teta
...
CMatrizEsparsa Scndec1ExtDE::MatrizLimqMax()
{
	int n_a = n;
	int JJ = 0;
	int flag1a = 0;		// referente à var. teta
...
CMatrizEsparsa Scndec1ExtDE::MatrizTup()
{
...
CMatrizEsparsa Scndec1ExtDE::MatrizTdown()
{
...
CMatrizEsparsa Scndec1ExtDE::MatrizTupDown()
{
...
CMatrizEsparsa Scndec1ExtDE::MatrizRampaUp()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec1ExtDE::MatrizRampaDown()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec1ExtDE::MatrizLimPtMin()
{
	if (flag7 == 0)
	{
		// T * I
...
CMatrizEsparsa Scndec1ExtDE::MatrizLimPtMax()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec1ExtDE::MatrizRestCP()
{
	// T * I
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec1ExtDE::MatrizVmeta()
{
	int n_a = n;
	size_t R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
...
CMatrizEsparsa Scndec1ExtDE::MatrizBalPotencia()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec1ExtDE::MatrizBalVazao()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec1ExtDE::MatrizFuncProd()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec1ExtDE::MatrizPhMax()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec1ExtDE::MatrizReserva()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec1ExtDE::MatrizCortesF()
{
	// T * I
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec1ExtDE::MatrizRestNAnt()
{
	...
	for (int n_cen = 0; n_cen < sistema_a->GetNCenarios() - 1; n_cen++)
	{
		...
		//	if (sistema_a->GetFlagTbinaryModel() == 1)		// "modern" model
		//	{
		//		//for (size_t i = 0; i < sistema_a->termeletricasVtr.size(); i++)		//up
		//		//{
		//		//	a.RemoverTodosElementos();
		//		//	a.InserirElemento(0, i + deltax + n_cen*n, 1);	// x_w
		//		//	for (int j = 0; j < sistema_a->GetNCenarios(); j++)	// loop para todos elementos da restricao
		...
		//	else
		//	{
		//		//for (size_t i = 0; i < sistema_a->termeletricasVtr.size(); i++)	//cp
		//		//{
		//		//	a.RemoverTodosElementos();
		//		//	a.InserirElemento(0, i + deltax + n_cen*n, 1);	// x_w
		//		//	for (int j = 0; j < sistema_a->GetNCenarios(); j++)	// loop para todos elementos da restricao
		...
		//		//{
		//		//	a.RemoverTodosElementos();
		//		//	a.InserirElemento(0, b + deltax + n_cen*n, 1);	// x_w
		//		//	for (int j = 0; j < sistema_a->GetNCenarios(); j++)	// loop para todos elementos da restricao
		//		//		a.InserirElemento(0, b + deltax + j*n, - sistema_a->hidreletricasVtr[0].GetProbAfluencia(j));	// sum_w(p_w * x_w)
		//		//	Alin.JuntarColuna(&a);
		//		//}
		...
		//	{
		//		//a.RemoverTodosElementos();
		//		//a.InserirElemento(0, deltax + n_cen*n, 1);	// x_w
		//		//for (int j = 0; j < sistema_a->GetNCenarios(); j++)	// loop para todos elementos da restricao
		//		//	a.InserirElemento(0, deltax + j*n, - sistema_a->hidreletricasVtr[0].GetProbAfluencia(j));	// sum_w(p_w * x_w)
		//		//Alin.JuntarColuna(&a);
		//		deltax += 1;
		//	}
		//}
...
vetorfloat2 Scndec1ExtDE::LimRestDemanda(int &cenario)
{
...
vetorfloat2 Scndec1ExtDE::LimRestDemandaBarraUnica(int &cenario)
{
	size_t B = sistema_a->barrasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec1ExtDE::LimFluxo0(int &cenario)
{
	vetorfloat2 Lim;
...
vetorfloat2 Scndec1ExtDE::LimFluxo2(int &cenario)
{
	vetorfloat2 Lim;
	size_t L = sistema_a->linhasVtr.size();
	size_t B = sistema_a->barrasVtr.size();
...
vetorfloat2 Scndec1ExtDE::LimPhgMin()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec1ExtDE::LimPhgMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec1ExtDE::LimBalHid(int &cenario)
{
	double deltaT;
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec1ExtDE::LimQMin()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec1ExtDE::LimQMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec1ExtDE::LimTup()
{
	if (flag7 == 0)
	{
		int n_a = n;
...
vetorfloat2 Scndec1ExtDE::LimTdown()
{
	if (flag7 == 0)
	{
		int n_a = n;
...
vetorfloat2 Scndec1ExtDE::LimTupDown()
{
...
vetorfloat2 Scndec1ExtDE::LimRampaUp()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec1ExtDE::LimRampaDown()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec1ExtDE::LimPtMin()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec1ExtDE::LimPtMax()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec1ExtDE::LimRestCP()
{
	// T * I
	int n_a = n;
	int I = sistema_a->termeletricasVtr.size();
...
vetorfloat2 Scndec1ExtDE::LimVmeta()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec1ExtDE::LimBalPotenciaL()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec1ExtDE::LimBalVazaoL()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec1ExtDE::LimFuncProdL()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int i = 0; i < R; i++)
...
vetorfloat2 Scndec1ExtDE::LimPhMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec1ExtDE::LimReserva(int &cenario)
{
	size_t B = sistema_a->barrasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec1ExtDE::LimCortesF()
{
	// T * I
	int I = sistema_a->termeletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec1ExtDE::LimRestNAnt()
{
	vetorfloat2 Lim;
	vetorfloat L; L.resize(2);
	L[0] = 1;L[1] = 0;
...
void Scndec1ExtDE::MatrizRestricoesLineares(vetorint * indexL, vetorint * indexC, vetorfloat * indexV, vetorint * nnZ, int * n_restricoes, int &cenario)		// Matriz M é composta de 3 vetores, cada coluna (vetor) é : [indexL indexC Valor]
{
	CMatrizEsparsa M(0);
	//int count = 0;
...
void Scndec1ExtDE::MatrizLimitesLineares(vetorint * LimTipo, vetorfloat * LimValor, int &cenario)
{
	vetorfloat2 L;
	if ( sistema_a->GetFlagModeloRede() == 1 )
	{
...
Scndec1ExtDE::Scndec1ExtDE(CSistema * const sistema_end) :ambGRB(GRBEnv()),modeloGRB(GRBModel(ambGRB))
{
...
Scndec1ExtDE::~Scndec1ExtDE(void)
{
	delete vars;
	delete constr;
}

void Scndec1ExtDE::CriarVariaveis()
{
	try 
	{
		size_t I = sistema_a->termeletricasVtr.size();
...
void Scndec1ExtDE::CriarRestricoes()
{
	try
	{
		int n_restricoes = 0;
...
void Scndec1ExtDE::CriarFuncaoObjetivo()
{
	try 
	{
		int R = sistema_a->hidreletricasVtr.size();
...
void Scndec1ExtDE::FixarCondIniciais()
{
...
double Scndec1ExtDE::ResolverProblema(LMRow lambda, Results * results)
{
	try
	{
		...
		{
			cout << "Inviabilidade no problema extendido : " << nStatus << endl;
