...
/** @file
 * 
 * Oracle para a decomposiçao espacial 3
...
class Spcdec3Fi : public FiOracle
{
	CSistema * sistema_a;
	Spcdec3Results * resultadosGurobi;

	GRBEnv ambGRB;										// Ambiente Gurobi
	Spcdec3SPHA * subproblemaHA;
	Spcdec3SPHE * subproblemaHE;
	Spcdec3SPT * subproblemaT;
	Spcdec3SPD * subproblemaD;
	Hrstc * heuristica;
	ofstream * log_auxiliar;

	vetorfloat Fi5, Fi10, Fi20;						// Média movel
...
/*--------------------------------------------------------------------------*/
	...
	Spcdec3Fi( CSistema * const sistema_end , Spcdec3Results * const resultadosGurobi_end, int tipo_dual);
