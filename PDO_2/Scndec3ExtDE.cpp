...
CMatrizEsparsa Scndec3ExtDE::MatrizRestDemanda()	// Monta matriz da restrição de atendimento a demanda
{
	// T * B
	int n_a = n;
...
CMatrizEsparsa Scndec3ExtDE::MatrizRestDemandaBarraUnica()	// Monta matriz da restrição de atendimento a demanda
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec3ExtDE::MatrizLimFluxo()
{
	int n_a = n;
...
CMatrizEsparsa Scndec3ExtDE::MatrizLimPhgMin()
{
	int n_a = n;
	int JJ = 0;
...
CMatrizEsparsa Scndec3ExtDE::MatrizLimPhgMax()
{
	int n_a = n;
	int JJ = 0;
	for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)
...
CMatrizEsparsa Scndec3ExtDE::MatrizBalHid()
{
	// T * R
	int flag1a = 0;		// referente à var. teta
	if (flag1 == 1)
...
CMatrizEsparsa Scndec3ExtDE::MatrizLimqMin()
{
	int n_a = n;
	int JJ = 0;
	int flag1a = 0;		// referente à var. teta
...
CMatrizEsparsa Scndec3ExtDE::MatrizLimqMax()
{
	int n_a = n;
	int JJ = 0;
	int flag1a = 0;		// referente à var. teta
...
CMatrizEsparsa Scndec3ExtDE::MatrizTup()
{
...
CMatrizEsparsa Scndec3ExtDE::MatrizTdown()
{
...
CMatrizEsparsa Scndec3ExtDE::MatrizTupDown()
{
...
CMatrizEsparsa Scndec3ExtDE::MatrizRampaUp()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec3ExtDE::MatrizRampaDown()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec3ExtDE::MatrizLimPtMin()
{
	if (flag7 == 0)
	{
		// T * I
...
CMatrizEsparsa Scndec3ExtDE::MatrizLimPtMax()
{
	// T * I
	if (flag7 == 0)
	{
...
CMatrizEsparsa Scndec3ExtDE::MatrizRestCP()
{
	// T * I
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec3ExtDE::MatrizVmeta()
{
	int n_a = n;
	size_t R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
...
CMatrizEsparsa Scndec3ExtDE::MatrizBalPotencia()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec3ExtDE::MatrizBalVazao()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec3ExtDE::MatrizFuncProd()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec3ExtDE::MatrizPhMax()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec3ExtDE::MatrizReserva()
{
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
	size_t R = sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec3ExtDE::MatrizCortesF()
{
	// T * I
	int n_a = n;
	n_a = n_a - flag2*sistema_a->hidreletricasVtr.size();
...
CMatrizEsparsa Scndec3ExtDE::MatrizRestNAnt()
{
	// x_w = sum_w(p_w * x_w)
...
vetorfloat2 Scndec3ExtDE::LimRestDemanda(int &cenario)
{
...
vetorfloat2 Scndec3ExtDE::LimRestDemandaBarraUnica(int &cenario)
{
	size_t B = sistema_a->barrasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec3ExtDE::LimFluxo0(int &cenario)
{
	vetorfloat2 Lim;
...
vetorfloat2 Scndec3ExtDE::LimFluxo2(int &cenario)
{
	vetorfloat2 Lim;
	size_t L = sistema_a->linhasVtr.size();
	size_t B = sistema_a->barrasVtr.size();
...
vetorfloat2 Scndec3ExtDE::LimPhgMin()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec3ExtDE::LimPhgMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec3ExtDE::LimBalHid(int &cenario)
{
	double deltaT;
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec3ExtDE::LimQMin()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec3ExtDE::LimQMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int r = 0; r < R; r++)
...
vetorfloat2 Scndec3ExtDE::LimTup()
{
	if (flag7 == 0)
	{
		int n_a = n;
...
vetorfloat2 Scndec3ExtDE::LimTdown()
{
	if (flag7 == 0)
	{
		int n_a = n;
...
vetorfloat2 Scndec3ExtDE::LimTupDown()
{
...
vetorfloat2 Scndec3ExtDE::LimRampaUp()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec3ExtDE::LimRampaDown()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec3ExtDE::LimPtMin()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec3ExtDE::LimPtMax()
{
	if (flag7 == 0)
	{
		// T * I
...
vetorfloat2 Scndec3ExtDE::LimRestCP()
{
	// T * I
	int n_a = n;
	int I = sistema_a->termeletricasVtr.size();
...
vetorfloat2 Scndec3ExtDE::LimVmeta()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec3ExtDE::LimBalPotenciaL()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec3ExtDE::LimBalVazaoL()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec3ExtDE::LimFuncProdL()
{
	int R = sistema_a->hidreletricasVtr.size();
	int JJ = 0;
	for (int i = 0; i < R; i++)
...
vetorfloat2 Scndec3ExtDE::LimPhMax()
{
	int R = sistema_a->hidreletricasVtr.size();
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, R * T, 2);
...
vetorfloat2 Scndec3ExtDE::LimReserva(int &cenario)
{
	size_t B = sistema_a->barrasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec3ExtDE::LimCortesF()
{
	// T * I
	int I = sistema_a->termeletricasVtr.size();
	vetorfloat2 Lim;
...
vetorfloat2 Scndec3ExtDE::LimRestNAnt()
{
	vetorfloat2 Lim;
	vetorfloat L; L.resize(2);
	L[0] = 1;L[1] = 0;
	...
	for (size_t i = 0; i < sistema_a->hidreletricasVtr.size(); i++)
		JJ += sistema_a->hidreletricasVtr[i].GetNGrupos();
	//x = [pt u v] das restrições de não antecipatividade
	int n1 = sistema_a->GetTt1() * ( 2*sistema_a->termeletricasVtr.size() + sistema_a->hidreletricasVtr.size());
	for (int n_cen = 0; n_cen < sistema_a->GetNCenarios() - 1; n_cen++)
...
void Scndec3ExtDE::MatrizRestricoesLineares(vetorint * indexL, vetorint * indexC, vetorfloat * indexV, vetorint * nnZ, int * n_restricoes, int &cenario)		// Matriz M é composta de 3 vetores, cada coluna (vetor) é : [indexL indexC Valor]
{
	CMatrizEsparsa M(0);
...
void Scndec3ExtDE::MatrizLimitesLineares(vetorint * LimTipo, vetorfloat * LimValor, int &cenario)
{
	vetorfloat2 L;
	if ( sistema_a->GetFlagModeloRede() == 1 )
	{
...
Scndec3ExtDE::Scndec3ExtDE(CSistema * const sistema_end) :ambGRB(GRBEnv()),modeloGRB(GRBModel(ambGRB))
{
...
Scndec3ExtDE::~Scndec3ExtDE(void)
{
	delete vars;
	delete constr;
}

void Scndec3ExtDE::CriarVariaveis()
{
	try 
	{
		size_t I = sistema_a->termeletricasVtr.size();
			...
			for (int t = 0; t < sistema_a->GetTt2(); t++)
			{
				...
				for (size_t r = 0; r < sistema_a->hidreletricasVtr.size(); r++)	//v
					if ( t < sistema_a->GetTt1())
						...
						modeloGRB.addVar(double(sistema_a->hidreletricasVtr[r].GetVmin(t+cen*(sistema_a->GetTt2()-sistema_a->GetTt1()))), double(sistema_a->hidreletricasVtr[r].GetVmax(t+cen*(sistema_a->GetTt2()-sistema_a->GetTt1()))), 0.0, GRB_CONTINUOUS, "");
...
void Scndec3ExtDE::CriarRestricoes()
{
	try
	{
		int n_restricoes = 0;
...
void Scndec3ExtDE::CriarFuncaoObjetivo()
{
	try 
	{
		int R = sistema_a->hidreletricasVtr.size();
		...
		for (int n_cen = 0; n_cen < sistema_a->GetNCenarios(); n_cen++)
		{
			...
			for (int t = 0; t < T; t++)
			{
				...
				if ((t >= sistema_a->GetTt1()) && ((t + 1 - sistema_a->GetTt1())%(sistema_a->GetTt2() - sistema_a->GetTt1()) == 0))
					if (sistema_a->GetFlagVfol() == true)
						for (int r = 0; r < R; r++)
							vars[r + I*(3 + flag4 + flag7) + flag1a*(B - 1) + (4+flag3)*R + 3*JJ + flag1d*B + (1 - flag1d) + delta + n_cen*n].set(GRB_DoubleAttr_Obj, sistema_a->GetCustoVfol()*deltaT);		//vfol
				delta += nt;
			}
		}
		modeloGRB.update();
...
void Scndec3ExtDE::FixarCondIniciais()
{
...
double Scndec3ExtDE::ResolverProblema(LMRow lambda, Results * results)
{
	try
	{
		...
		if (sistema_a->GetNCenarios() >= 16)
			modeloGRB.getEnv().set(GRB_DoubleParam_TimeLimit, 3600);
		if (sistema_a->GetNCenarios() >= 25)
		...
		if ((nStatus == 2) || (nStatus == 9) || (nStatus == 13))
		{
			...
			results->GravarSolExtDE(vars, constr, no, 0, rest_o, true);
			// nessa decompositção a ordem das restrições estão diferentes, portanto o vetor lambda deve ser rearranjado
		}
		else
		{
			...
			fo = 0;
			results->GravarSolExtDE(no, 0, rest_o, true);
		}
