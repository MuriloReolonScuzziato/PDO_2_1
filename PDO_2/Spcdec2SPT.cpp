...
CMatrizEsparsa Spcdec2SPT::MatrizTup(int n_a, int nu)
{
...
CMatrizEsparsa Spcdec2SPT::MatrizTdown(int n_a, int nu)
{
...
CMatrizEsparsa Spcdec2SPT::MatrizTupDown(int n_a, int nu)
{
...
CMatrizEsparsa Spcdec2SPT::MatrizRampaUp(int n_a, int nu)
{
	if (flag7 == 0)
	{
		// T
...
CMatrizEsparsa Spcdec2SPT::MatrizRampaDown(int n_a, int nu)
{
	// T
	if (flag7 == 0)
	{
...
CMatrizEsparsa Spcdec2SPT::MatrizLimPtMin(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
CMatrizEsparsa Spcdec2SPT::MatrizLimPtMax(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
CMatrizEsparsa Spcdec2SPT::MatrizRestCP(int n_a, int nu)
{
	// T * I
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	CMatrizEsparsa Alin(0, n_a);
...
CMatrizEsparsa Spcdec2SPT::MatrizCortesF(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	CMatrizEsparsa Alin(0, n_a);
	CMatrizEsparsa a(1, n_a);
...
vetorfloat2 Spcdec2SPT::LimTup(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec2SPT::LimTdown(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec2SPT::LimTupDown(int n_a, int nu)
{
	// T
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec2SPT::LimRampaUp(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec2SPT::LimRampaDown(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec2SPT::LimPtMin(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec2SPT::LimPtMax(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec2SPT::LimRestCP(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, T, 2);
...
vetorfloat2 Spcdec2SPT::LimCortesF(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
...
void Spcdec2SPT::MatrizRestricoesLineares(int n_a, CMatrizEsparsa &MM, int nu)		// Matriz M é composta de 3 vetores, cada coluna (vetor) é : [indexL indexC Valor]
{
	CMatrizEsparsa M(0);
	M = MatrizTup(n_a, nu);									
...
void Spcdec2SPT::MatrizLimitesLineares(int n_a, vetorint * LimTipo, vetorfloat * LimValor, int nu)
{
	vetorfloat2 L;
	L = LimTup(n_a, nu);
...
Spcdec2SPT::Spcdec2SPT(CSistema * const sistema_end, const GRBEnv &ambiente_gurobi)
{
...
void Spcdec2SPT::CriarVariaveis(int nu)
{
	try 
	{
...
void Spcdec2SPT::CriarRestricoes(int nu)
{
	try
	{
		vetorint LimTipo;
...
void Spcdec2SPT::CriarFuncaoObjetivoRL(const vetorfloat * const lambda, int nu)
{
	try 
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
void Spcdec2SPT::CriarFuncaoObjetivoRL2(const vetorfloat * const lambda, int nu)
{
	try 
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
		...
		// Termos quadráticos
		if (sistema_a->GetFlagInitAproxCT() == 0)
			cout << "CriarFuncaoObjetivoRL2: Termo quadrático não suportado para essa modelagem!!" << endl;
...
void Spcdec2SPT::FixarCondIniciais(int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	int c = 0;
	int TUr = 0;
...
int Spcdec2SPT::ResolverProblemaRL(Spcdec2Results * resultadoGurobi, const vetorfloat * const lambda, const int iter, int usina)
{
	...
	try
	{
		...
		resultadoGurobi->GravarSolucao(fo_i, x_i, nStatus, resultadoGurobi->GetCH() + usina);

	} catch(GRBException e) {
		cout << "Error code = " << e.getErrorCode() << endl;
		cout << e.getMessage() << endl;
		resultadoGurobi->GravarSolucao(fo_i, x_i, e.getErrorCode(), resultadoGurobi->GetCH() + usina);
	} catch(...) {
		cout << "Exception during optimization" << endl;
	}
return 0;
