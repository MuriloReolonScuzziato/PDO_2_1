...
/** @file
 * 
 * Oracle para a decomposiçao por cenários 3 (somente algumas váriaveis chave
 * são consideradas nas restrições de não antecipatividade: pt, u, v)
...
typedef vector<Scndec3SPC *> vetorSPC;
...
class Scndec3Fi : public FiOracle
{
	CSistema * sistema_a;
	Scndec3Results * resultadosGurobi;
...
/*--------------------------------------------------------------------------*/
	...
	Scndec3Fi( CSistema * const sistema_end , Scndec3Results * const resultadosGurobi_end, int tipo_dual);
