#include "Spcdec1SPT.h"

// Criar restrições
// ------------------------------------------------

//Funções para montar o lado esquerdo das restrições lineares
CMatrizEsparsa Spcdec1SPT::MatrizTup(int n_a, int nu)
{
...
CMatrizEsparsa Spcdec1SPT::MatrizTdown(int n_a, int nu)
{
...
CMatrizEsparsa Spcdec1SPT::MatrizTupDown(int n_a, int nu)
{
...
CMatrizEsparsa Spcdec1SPT::MatrizRampaUp(int n_a, int nu)
{
	if (flag7 == 0)
	{
		// T
...
CMatrizEsparsa Spcdec1SPT::MatrizRampaDown(int n_a, int nu)
{
	// T
	if (flag7 == 0)
	{
...
CMatrizEsparsa Spcdec1SPT::MatrizLimPtMin(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
CMatrizEsparsa Spcdec1SPT::MatrizLimPtMax(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
CMatrizEsparsa Spcdec1SPT::MatrizRestCP(int n_a, int nu)
{
	// T * I
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	CMatrizEsparsa Alin(0, n_a);
...
CMatrizEsparsa Spcdec1SPT::MatrizCortesF(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	CMatrizEsparsa Alin(0, n_a);
	CMatrizEsparsa a(1, n_a);
...
vetorfloat2 Spcdec1SPT::LimTup(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec1SPT::LimTdown(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec1SPT::LimTupDown(int n_a, int nu)
{
	// T
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
...
vetorfloat2 Spcdec1SPT::LimRampaUp(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec1SPT::LimRampaDown(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec1SPT::LimPtMin(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec1SPT::LimPtMax(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 Spcdec1SPT::LimRestCP(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, T, 2);
...
vetorfloat2 Spcdec1SPT::LimCortesF(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
...
void Spcdec1SPT::MatrizRestricoesLineares(int n_a, CMatrizEsparsa &MM, int nu)		// Matriz M é composta de 3 vetores, cada coluna (vetor) é : [indexL indexC Valor]
{
	CMatrizEsparsa M(0);
	M = MatrizTup(n_a, nu);									
...
void Spcdec1SPT::MatrizLimitesLineares(int n_a, vetorint * LimTipo, vetorfloat * LimValor, int nu)
{
	vetorfloat2 L;
	L = LimTup(n_a, nu);
...
Spcdec1SPT::Spcdec1SPT(CSistema * const sistema_end, const GRBEnv &ambiente_gurobi)
{
...
void Spcdec1SPT::CriarVariaveis(int nu)
{
	try 
	{
...
void Spcdec1SPT::CriarRestricoes(int nu)
{
	try
	{
		vetorint LimTipo;
...
void Spcdec1SPT::CriarFuncaoObjetivoRL(const vetorfloat * const lambda, int nu)
{
	try 
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
void Spcdec1SPT::CriarFuncaoObjetivoRL2(const vetorfloat * const lambda, int nu)
{
	try 
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
void Spcdec1SPT::FixarCondIniciais(int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	int c = 0;
	int TUr = 0;
...
int Spcdec1SPT::ResolverProblemaRL(Spcdec1Results * resultadoGurobi, const vetorfloat * const lambda, const int iter, int usina)
{
	...
	try
	{
		...
		resultadoGurobi->GravarSolucao(fo_i, x_i, nStatus, 1 + usina);

	} catch(GRBException e) {
		cout << "Error code = " << e.getErrorCode() << endl;
		cout << e.getMessage() << endl;
		resultadoGurobi->GravarSolucao(fo_i, x_i, e.getErrorCode(), 1 + usina);
	} catch(...) {
		cout << "Exception during optimization" << endl;
	}
return 0;
