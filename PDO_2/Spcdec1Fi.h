...
/** @file
 * 
 * Oracle para a decomposiçao espacial 1
...
class Spcdec1Fi : public FiOracle
{
	CSistema * sistema_a;
	Spcdec1Results * resultadosGurobi;

	GRBEnv ambGRB;										// Ambiente Gurobi
	Spcdec1SPH * subproblemaH;
	Spcdec1SPT * subproblemaT;
	Spcdec1SPD * subproblemaD;
	Hrstc * heuristica;
...
/*--------------------------------------------------------------------------*/
	...
	Spcdec1Fi( CSistema * const sistema_end , Spcdec1Results * const resultadosGurobi_end, int tipo_dual);
