...
public:
	Spcdec1SPT(CSistema * const sistema_end, const GRBEnv &ambiente_gurobi);
	~Spcdec1SPT(void);

	int ResolverProblemaRL(Spcdec1Results * resultadoGurobi, const vetorfloat * const lambda, const int iter, int usina);
