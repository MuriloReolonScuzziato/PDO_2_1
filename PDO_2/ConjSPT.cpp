...
CMatrizEsparsa ConjSPT::MatrizTup(int n_a, int nu)
{
...
CMatrizEsparsa ConjSPT::MatrizTdown(int n_a, int nu)
{
...
CMatrizEsparsa ConjSPT::MatrizTupDown(int n_a, int nu)
{
...
CMatrizEsparsa ConjSPT::MatrizRampaUp(int n_a, int nu)
{
	if (flag7 == 0)
	{
		// T
...
CMatrizEsparsa ConjSPT::MatrizRampaDown(int n_a, int nu)
{
	// T
	if (flag7 == 0)
	{
...
CMatrizEsparsa ConjSPT::MatrizLimPtMin(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
CMatrizEsparsa ConjSPT::MatrizLimPtMax(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
CMatrizEsparsa ConjSPT::MatrizRestCP(int n_a, int nu)
{
	// T * I
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	CMatrizEsparsa Alin(0, n_a);
...
CMatrizEsparsa ConjSPT::MatrizCortesF(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	CMatrizEsparsa Alin(0, n_a);
	CMatrizEsparsa a(1, n_a);
...
vetorfloat2 ConjSPT::LimTup(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 ConjSPT::LimTdown(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 ConjSPT::LimTupDown(int n_a, int nu)
{
	// T
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
...
vetorfloat2 ConjSPT::LimRampaUp(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 ConjSPT::LimRampaDown(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 ConjSPT::LimPtMin(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 ConjSPT::LimPtMax(int n_a, int nu)
{
	if (flag7 == 0)
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
vetorfloat2 ConjSPT::LimRestCP(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
	DimensionarMatriz(&Lim, T, 2);
...
vetorfloat2 ConjSPT::LimCortesF(int n_a, int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	vetorfloat2 Lim;
...
void ConjSPT::MatrizRestricoesLineares(int n_a, vetorint * indexL, vetorint * indexC, vetorfloat * indexV, vetorint * nnZ, int nu, int &n_restricoes)		// Matriz M é composta de 3 vetores, cada coluna (vetor) é : [indexL indexC Valor]
{
	CMatrizEsparsa M(0);
	int count = 0;
	M = MatrizTup(n_a, nu);									
...
void ConjSPT::MatrizLimitesLineares(int n_a, vetorint * LimTipo, vetorfloat * LimValor, int nu)
{
	vetorfloat2 L;
	L = LimTup(n_a, nu);
...
ConjSPT::ConjSPT(CSistema * const sistema_end, const GRBEnv &ambiente_gurobi)
{
...
void ConjSPT::CriarVariaveis(int nu)
{
	try 
	{
...
void ConjSPT::CriarRestricoes(int nu)
{
	try
	{
...
void ConjSPT::CriarFuncaoObjetivoRL(const vetorfloat * const lambda, int nu)
{
	try 
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
void ConjSPT::CriarFuncaoObjetivoRL2(const vetorfloat * const lambda, int nu)
{
	try 
	{
		int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
...
void ConjSPT::FixarCondIniciais(int nu)
{
	int T = sistema_a->GetTt1() + sistema_a->GetNCenarios() * (sistema_a->GetTt2() - sistema_a->GetTt1());
	int c = 0;
	int TUr = 0;
...
int ConjSPT::ResolverProblemaRL(ResultadosConj * resultadoGurobi, const vetorfloat * const lambda, const int iter, int usina)
{
